...
# Journal CRUD
 curl -i -X POST -H 'Content-Type: application/json' -d '{"title": "test entry", "description": "dear diary, today I wrote a journal entry...", "user_id": "1" }' http://localhost:5000/journal
 curl -i -X PUT -H 'Content-Type: application/json' -d '{"new_title": "test journal"}' http://localhost:5000/journal
 curl -i -X GET -H 'Content-Type: application/json' http://localhost:5000/journal
 curl -i -X DELETE -H 'Content-Type: application/json' -d '{"title": "test journal"}' http://localhost:5000/journal
 curl -i -X GET -H 'Content-Type: application/json' http://localhost:5000/journal
